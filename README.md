...
증가하는 인건비와 고객의 빠른 결제 요구에 맞춰 셀프 계산대 도입이 확산되고 있습니다. 
그러나 기존 시스템은 주류 구매 시 직원의 신분 확인이 필요하여 자동화 흐름이 끊기는 한계가 있었습니다. 또한 직원이 직접 확인하는 방식은 위조 신분증 사용이나 부주의로 인한 미성년자 주류 판매 발생 시 매장이 법적 책임을 지게 되는 위험이 존재했습니다. 

이에 **Self-Check Kiosk (스마트 셀프 계산대)**는 일본의 성인 인증 자동화 시스템을 벤치마킹하여 국내 환경에서의 적용 가능성을 시뮬레이션하고자 합니다. 이를 통해 성인 인증 및 법적 책임 동의 과정을 자동화하여 직원의 개입과 법적 리스크를 최소화하고, 비대면 트렌드에 부합하는 완전한 셀프 결제 경험을 제시하는 것을 목표로 합니다.
